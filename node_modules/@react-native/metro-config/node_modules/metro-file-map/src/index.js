...
class HasteMap extends _events.default {
  ...
  build() {
    ...
    if (!this._buildPromise) {
      this._buildPromise = (async () => {
        var _this$_startupPerfLog4, _this$_startupPerfLog5, _fileDelta$clocks;
        let initialData;
        ...
        _this$_startupPerfLog4 === void 0
          ? void 0
          : _this$_startupPerfLog4.point("constructFileSystem_start");
        const FileSystem = this._options.enableSymlinks
          ? _TreeFS.default
          : _HasteFS.default;
        ...
        _this$_startupPerfLog5 === void 0
          ? void 0
          : _this$_startupPerfLog5.point("constructFileSystem_end");
    ...
    return this._buildPromise.then((result) => {
      ...
      _this$_startupPerfLog6 === void 0
        ? void 0
        : _this$_startupPerfLog6.point("build_end");
      return result;
    });
  }
   ...
   */
  async read() {
    var _this$_startupPerfLog7, _this$_startupPerfLog9;
    let data;
    (_this$_startupPerfLog7 = this._startupPerfLogger) === null ||
    _this$_startupPerfLog7 === void 0
      ? void 0
      : _this$_startupPerfLog7.point("read_start");
    try {
      ...
      _this$_startupPerfLog8 === void 0
        ? void 0
        : _this$_startupPerfLog8.annotate({
            string: {
    ...
    _this$_startupPerfLog9 === void 0
      ? void 0
      : _this$_startupPerfLog9.point("read_end");
    return data;
  }
  ...
  async _buildFileDelta(previousState) {
    ...
    _this$_startupPerfLog10 === void 0
      ? void 0
      : _this$_startupPerfLog10.point("buildFileDelta_start");
    const {
      computeSha1,
      enableSymlinks,
      extensions,
    ...
    return watcher.crawl().then((result) => {
      ...
      _this$_startupPerfLog11 === void 0
        ? void 0
        : _this$_startupPerfLog11.point("buildFileDelta_end");
      return result;
    });
  }
  ...
  async _applyFileDelta(fileSystem, moduleMap, delta) {
    var _this$_startupPerfLog12,
      _this$_startupPerfLog13,
      _this$_startupPerfLog14,
      _this$_startupPerfLog15,
      _this$_startupPerfLog16,
      _this$_startupPerfLog17,
      _this$_startupPerfLog18,
      _this$_startupPerfLog19,
      _this$_startupPerfLog20,
      _this$_startupPerfLog21;
    (_this$_startupPerfLog12 = this._startupPerfLogger) === null ||
    _this$_startupPerfLog12 === void 0
      ? void 0
      : _this$_startupPerfLog12.point("applyFileDelta_start");
    ...
    _this$_startupPerfLog14 === void 0
      ? void 0
      : _this$_startupPerfLog14.point("applyFileDelta_remove_start");
    ...
    _this$_startupPerfLog15 === void 0
      ? void 0
      : _this$_startupPerfLog15.point("applyFileDelta_remove_end");
    ...
    _this$_startupPerfLog16 === void 0
      ? void 0
      : _this$_startupPerfLog16.point("applyFileDelta_preprocess_end");
    ...
    _this$_startupPerfLog17 === void 0
      ? void 0
      : _this$_startupPerfLog17.point("applyFileDelta_process_start");
    try {
    ...
    _this$_startupPerfLog18 === void 0
      ? void 0
      : _this$_startupPerfLog18.point("applyFileDelta_process_end");
    (_this$_startupPerfLog19 = this._startupPerfLogger) === null ||
    _this$_startupPerfLog19 === void 0
      ? void 0
      : _this$_startupPerfLog19.point("applyFileDelta_add_start");
    ...
    _this$_startupPerfLog20 === void 0
      ? void 0
      : _this$_startupPerfLog20.point("applyFileDelta_add_end");
    (_this$_startupPerfLog21 = this._startupPerfLogger) === null ||
    _this$_startupPerfLog21 === void 0
      ? void 0
      : _this$_startupPerfLog21.point("applyFileDelta_end");
  }
  _cleanup() {
  ...
  async _takeSnapshotAndPersist(
    ...
    var _this$_startupPerfLog22, _this$_startupPerfLog23;
    (_this$_startupPerfLog22 = this._startupPerfLogger) === null ||
    _this$_startupPerfLog22 === void 0
      ? void 0
      : _this$_startupPerfLog22.point("persist_start");
    ...
    _this$_startupPerfLog23 === void 0
      ? void 0
      : _this$_startupPerfLog23.point("persist_end");
  }
  ...
  async _watch(fileSystem, moduleMap) {
    var _this$_startupPerfLog24, _this$_startupPerfLog26;
    (_this$_startupPerfLog24 = this._startupPerfLogger) === null ||
    _this$_startupPerfLog24 === void 0
      ? void 0
      : _this$_startupPerfLog24.point("watch_start");
    if (!this._options.watch) {
      var _this$_startupPerfLog25;
      (_this$_startupPerfLog25 = this._startupPerfLogger) === null ||
      _this$_startupPerfLog25 === void 0
        ? void 0
        : _this$_startupPerfLog25.point("watch_end");
      return;
    }
    ...
    (_this$_startupPerfLog26 = this._startupPerfLogger) === null ||
    _this$_startupPerfLog26 === void 0
      ? void 0
      : _this$_startupPerfLog26.point("watch_end");
  }
  ...
  async _shouldUseWatchman() {
    ...
    if (!this._canUseWatchmanPromise) {
      this._canUseWatchmanPromise = (0, _checkWatchmanCapabilities.default)(
        ...
        .then(() => true)
        .catch((e) => {
          var _this$_startupPerfLog27, _e$message;
          // TODO: Advise people to either install Watchman or set
          // `useWatchman: false` here?
          (_this$_startupPerfLog27 = this._startupPerfLogger) === null ||
          _this$_startupPerfLog27 === void 0
            ? void 0
            : _this$_startupPerfLog27.annotate({
                string: {
