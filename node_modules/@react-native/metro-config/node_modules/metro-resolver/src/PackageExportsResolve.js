 ...
 */
function normalizeExportsField(exportsField, raiseConfigError) {
 ...
 * conditional exports.
 */
function reduceExportMap(exportMap, conditionNames, raiseConfigError) {
  const result = {};
